...
namespace Distribuidora.RF.GUILayer
{
    public partial class frmABMUsuario : Form
    {
        ...
        {
            LlenarCombo(cboPerfil, oPerfilService.ObtenerTodos(), "Nombre", "IdP");
            switch (formMode)
            {
                ...
                case FormMode.insert:
                    {
                        if (ExisteUsuario() == false)
                        {
                            if (ValidarCampos())
                            {
                                ...
                                oUsuario.Perfil.IdP = (int)cboPerfil.SelectedValue;
                                oUsuario.Estado = "S";
                ...
                case FormMode.update:
                    {
                        if (ValidarCampos())
                        {
                            ...
                            oUsuarioSelected.Perfil.IdP = (int)cboPerfil.SelectedValue;
